...
private let dateFormatter: DateFormatter = {
    print("📆 I JUST CREATED A DATE FORMAT")
        ...
        LocalNotificationManager.isAuthorized { (authorized) in
            DispatchQueue.main.async {
                if authorized == false && self.reminderSwitch.isOn {
                    self.oneButtonAlert(title: "User Has Not Allowed Notifications", message: "To receive alerts for reminders, open the Setttings app, select To Do List > Notifications > Allow Notifications")
